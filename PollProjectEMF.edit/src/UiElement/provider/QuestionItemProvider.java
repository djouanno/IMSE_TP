...
/**
 * This is the item provider adapter for a {@link UiElement.Question} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class QuestionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UiElementPackage.Literals.QUESTION__ID,
				 true,
				 false,
				 false,
	...
	protected void addInputsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Question_inputs_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Question_inputs_feature", "_UI_Question_type"),
				 UiElementPackage.Literals.QUESTION__INPUTS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UiElementPackage.Literals.QUESTION__TEXT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Question.class)) {
			case UiElementPackage.QUESTION__ID:
			case UiElementPackage.QUESTION__TEXT:
