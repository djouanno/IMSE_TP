...
/**
 * This is the item provider adapter for a {@link UiElement.Panel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Panel_questions_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Panel_questions_feature", "_UI_Panel_type"),
				 UiElementPackage.Literals.PANEL__QUESTIONS,
				 true,
				 false,
				 true,
				 null,
