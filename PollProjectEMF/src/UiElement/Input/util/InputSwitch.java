...
public class InputSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case InputPackage.RADIO: {
				Radio radio = (Radio)theEObject;
				T result = caseRadio(radio);
				if (result == null) result = caseInput(radio);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case InputPackage.BUTTON: {
			...
			case InputPackage.DROPDOWN: {
				Dropdown dropdown = (Dropdown)theEObject;
				T result = caseDropdown(dropdown);
				if (result == null) result = caseInput(dropdown);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case InputPackage.TEXT: {
