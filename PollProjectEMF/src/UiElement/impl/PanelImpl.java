 ...
 * <ul>
 *   <li>{@link UiElement.impl.PanelImpl#getQuestions <em>Questions</em>}</li>
 *   <li>{@link UiElement.impl.PanelImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PanelImpl extends MinimalEObjectImpl.Container implements Panel {
	...
	protected EClass eStaticClass() {
		return UiElementPackage.Literals.PANEL;
	}
	...
	public EList<Question> getQuestions() {
		if (questions == null) {
			questions = new EObjectContainmentEList<Question>(Question.class, this, UiElementPackage.PANEL__QUESTIONS);
		}
		return questions;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UiElementPackage.PANEL__ID, oldId, id));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UiElementPackage.PANEL__QUESTIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UiElementPackage.PANEL__QUESTIONS:
				return getQuestions();
			case UiElementPackage.PANEL__ID:
				return getId();
		}
